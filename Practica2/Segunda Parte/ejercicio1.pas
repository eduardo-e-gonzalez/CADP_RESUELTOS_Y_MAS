...
b. ¿Qué imprime si se lee el valor 10 en la variable x y 
se cambia el encabezado del procedure por:
procedure suma(num1: integer; num2:integer);
R= va imprimir el mismo valor que introdujo el usuario,
ya que los 2 parametros estan pasados por valor;

c. ¿Qué sucede si se cambia el encabezado del procedure por:
procedure suma(var num1: integer; var num2:integer);
R= va a ser 1 + x + 1 + x + 1 + x + 1 + x + infinitamente, 
ya que los 2 parametros estan pasados por referencia; y el indice se inicializa en 0 
cada vez que se llama al procedure;
